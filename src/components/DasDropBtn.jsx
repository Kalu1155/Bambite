...
import bbwhiteicon from "../assets/images/bbwhiteicon.png"
const DashDropBtn = () => {
  return (
    <StyledWrapper>
      <label className="popup">
        <input type="checkbox" />
        {/* <div className="burger w-auto "> */}
        <div tabIndex={0} className="burger ">
          ...
          {/* <img src={bbwhiteicon} width={40} alt="" /> */}
          </div>
          {/* <p className='text-white py-4'>The BamBite</p> */}
