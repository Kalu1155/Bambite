  ...
  topDishes: [
    {
      ...
      name: "Grilled Salmon",
      price: 4200,
      img: "https://picsum.photos/120/80?dish1",
    },
    {
      id: "d2",
      name: "Truffle Pasta",
      price: 3500,
      img: "https://picsum.photos/120/80?dish2",
    },
    {
      id: "d3",
      name: "Caesar Salad",
      price: 1500,
      img: "https://picsum.photos/120/80?dish3",
    },
  ],
};
...
const CusResProfile = () => {
  ...
  function handleReserve(formData) {
    ...
    toast.info(
      `Reservation requested for ${formData.name} — ${formData.date} ${formData.time}`
    );
    closeModal();
  }
  return (
    <>
      ...
      <div className="customer-home">
        <p className="backbtn">page back</p>
          ...
          <main className="restaurant-content">
            ...
            <section className="floor-plan">
              ...
              <div
                ...
                role="img"
                aria-label="Floor plan placeholder"
              >
            ...
            <section className="reviews">
              ...
              <div className="review-list">
                <article className="review">
                  ...
                  <p>
                    Lovely food and good service. Perfect for anniversary
                    dinner.
                  </p>
                </article>
                <article className="review">
